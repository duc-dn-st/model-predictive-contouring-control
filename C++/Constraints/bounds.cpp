...
Bounds::Bounds(BoundsParam bounds_param) 
{
    ...
    l_bounds_x_(3) = bounds_param.lower_state_bounds.s_l;
    l_bounds_x_(4) = bounds_param.lower_state_bounds.v_l;
    l_bounds_x_(5) = bounds_param.lower_state_bounds.delta_l;
    ...
    u_bounds_x_(3) = bounds_param.upper_state_bounds.s_u;
    u_bounds_x_(4) = bounds_param.upper_state_bounds.v_u;
    u_bounds_x_(5) = bounds_param.upper_state_bounds.delta_u;
